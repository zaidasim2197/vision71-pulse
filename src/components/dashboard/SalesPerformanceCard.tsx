...
export function SalesPerformanceCard() {
  ...
  return (
    <div className="bento-card p-4 flex flex-col justify-between h-full">
      {/* Header */}
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="h-5 w-5 rounded-md text-muted-foreground/60 hover:text-foreground"
              title="Metric info [i]"
            >
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">
            Realized Net Sales: <strong className="text-foreground font-mono">{formatCompactPKR(totalNet)}</strong>
          </p>
        </div>
